...
class ArenaMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var testweek:String = "";//WeekData.createWeekFile;

		WeekData.weeksList = ["crack","freeplay","covers","smash","tutorial","week1","week2","week3","week4","week5","week6","week7"];
...
//	addSong("Bopeebo", 0, "dad", FlxColor.fromRGB(146, 113, 253));
